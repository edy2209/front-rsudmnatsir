...
export default function TestApiPage() {
  ...
  const ResultCard = ({ title, result }: { title: string; result: ApiResponse | null }) => (
    <motion.div
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50 py-20">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <ResultCard title="GET Request Result" result={getResult} />
          <ResultCard title="POST Request Result" result={postResult} />
        </motion.div>
