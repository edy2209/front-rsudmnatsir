    ...
    <PageLayout>
      ...
      <div className="relative bg-gradient-to-br from-emerald-50 via-teal-50 to-cyan-50 py-20 overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-5">
          <div className="grid grid-cols-8 gap-4 h-full">
            {[...Array(64)].map((_, i) => (
              <div key={i} className="bg-teal-600 rounded-full w-2 h-2 animate-pulse" style={{animationDelay: `${i * 0.1}s`}}></div>
            ))}
          </div>
        </div>
        ...
        <div className="absolute inset-0">
          <div className="absolute top-20 left-10 w-16 h-16 bg-teal-200/30 rounded-full animate-float"></div>
          <div className="absolute top-40 right-20 w-12 h-12 bg-emerald-200/40 rounded-full animate-float delay-1000"></div>
          <div className="absolute bottom-32 left-1/4 w-20 h-20 bg-cyan-200/50 rounded-full animate-float delay-500"></div>
        </div>

        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            <div className="mb-6">
              <PlusCircleIcon className="w-16 h-16 text-teal-600 mx-auto mb-4 animate-pulse" />
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="bg-teal-600 text-white px-8 py-4 rounded-full font-semibold hover:bg-teal-700 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1">
                Konsultasi Medis
              </button>
              <button className="border-2 border-teal-600 text-teal-600 px-8 py-4 rounded-full font-semibold hover:bg-teal-600 hover:text-white transition-all duration-300">
                Medical Check-up
              </button>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {stats.map((stat, index) => (
              <div key={index} className="text-center group">
                <div className="bg-gradient-to-br from-teal-50 to-emerald-50 p-6 rounded-2xl mb-4 group-hover:shadow-lg transition-all duration-300 group-hover:scale-105">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                {layananPenyakitDalam.map((layanan, index) => (
                  <div key={index} className="group">
                    <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 hover:border-teal-200 transform hover:-translate-y-2">
                ...
                {dokterSpesialis.map((dokter, index) => (
                  <div key={index} className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100">
                    <div className="text-center">
                      <div className="bg-gradient-to-br from-teal-100 to-emerald-100 p-6 rounded-full w-fit mx-auto mb-4">
                        <UserGroupIcon className="w-12 h-12 text-teal-600" />
                      </div>
                      <h3 className="text-xl font-bold text-gray-800 mb-2">{dokter.nama}</h3>
                      <p className="text-teal-600 font-semibold mb-1">{dokter.spesialisasi}</p>
                      <p className="text-sm text-gray-600 mb-4">{dokter.subspesialisasi}</p>
          ...
          {activeTab === 'kontak' && (
            <div className="fade-in">
              <div className="grid lg:grid-cols-2 gap-12">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">penyakitdalam@rsudmnatsir.sumbar.go.id</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">Lantai 1, Gedung Poliklinik</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">Minggu: Emergency Only</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-gradient-to-br from-teal-50 to-emerald-50 p-8 rounded-2xl">
                  <h3 className="text-2xl font-bold text-gray-800 mb-6">Konsultasi Medis</h3>
                  <form className="space-y-6">
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-2">Nama Lengkap</label>
                      <input type="text" className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent" />
                    </div>
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-2">Umur</label>
                      <input type="number" className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent" />
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <textarea rows={4} className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent"></textarea>
                    </div>
      ...
      <div className="bg-gradient-to-r from-teal-600 to-emerald-600 py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="bg-white text-teal-600 px-8 py-4 rounded-full font-semibold hover:bg-gray-100 transition-all duration-300 shadow-lg">
              Medical Check-up
            </button>
